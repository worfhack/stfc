...
const JoinSection = () => {
  ...
  const membershipBenefits = [
    ...
    },
    {
      ...
      description: 'Objets de collection et goodies exclusifs'
    },
    {
      icon: 'ri-discount-percent-line',
      title: 'Réductions',
      description: 'Tarifs préférentiels sur tous nos événements'
    },
    {
      icon: 'ri-medal-line',
      title: 'Badge Membre',
      description: 'Reconnaissance spéciale dans la communauté'
    }
  ];

  return (
    <section id="rejoindre" className="py-20 bg-gradient-to-br from-gray-900 via-blue-900/20 to-purple-900/20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Devenez membre de la plus grande communauté francophone Star Trek et vivez votre passion pleinement
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Membership Benefits */}
          <div>
            <h3 className="text-2xl font-bold text-blue-400 mb-8" style={{ fontFamily: 'Orbitron, sans-serif' }}>
              Avantages Membres
            </h3>
            ...
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-xs text-gray-400 leading-relaxed">
                  En vous inscrivant, vous acceptez de recevoir nos newsletters et informations sur les événements. 
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-300">
                  Vérifiez votre email pour confirmer votre inscription et accéder à votre espace membre.
                </p>
              </div>
            )}
